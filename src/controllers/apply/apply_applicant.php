      ...
      if ($applicants) {
        ...
        foreach($applicants as $applicant){
          if($applicant->getApplication()->getId() == $this->_application->getId()){
            ...
            $messageBody = "We have received a request to reset your password.  In order to reset your password you will need to click on the link at the bottom of this email.  This will take you back to the secure website were you will be able to enter a new password. \n \n"
