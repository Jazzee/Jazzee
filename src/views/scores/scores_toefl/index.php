...
if(isset($results)){?>
  ...
  <caption>Your search returned (<?php print count($results); ?>) results</caption>
    ...
    <tbody>
      <?php foreach($results as $toeflScore){?>
        <tr>
          ...
          <td><?php print $toeflScore->getNativeLanguage(); ?></td>
          <?php if($toeflScore->getTestType() == 'C' or $toeflScore->getTestType() == 'P'){?>
            ...
            <td><?php print $toeflScore->getTotal(); ?></td>
          <?php } else if($toeflScore->getTestType() == 'I'){?>
            <td>IBT</td>
            ...
            <td></td>
            <td><?php print $toeflScore->getIBTTotal(); ?></td>
          <?php }?>
        </tr>
      <?php } //results?>
    </tbody>
