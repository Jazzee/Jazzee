...
if ($payments) {?>
  <table id ='payments'>
    ...
    <thead><tr><th>Payment Type</th><th>Last Update</th><th>Applicant</th><th>Program</th><th>Cycle</th><th>Notes</th><th>Amount</th></tr></thead>
    <tbody><?php
      foreach ($payments as $payment) { ?>
        <tr>
          ...
          <td applicantId='<?php print $payment['applicantId']; ?>' 
              ...
              <?php print $payment['applicantFirstName'] ?> 
              <?php print $payment['applicantLastName'] ?>
