...
if ($payments) {?>
  <table id ='payments'>
    ...
    <thead><tr><th>Payment Type</th><th>Transaction ID</th><th>Last Update</th><th>Applicant ID</th><th>Last Name</th><th>First Name</th><th>Program</th><th>Cycle</th><th>Notes</th><th>Amount</th></tr></thead>
    <tbody><?php
      foreach ($payments as $payment) { ?>
        <tr>
          <td><?php print $payment['type']['name']; ?></td>
          <td><?php if($transactionId = reset($payment['notes'])){
              print $transactionId;
          }?></td>
