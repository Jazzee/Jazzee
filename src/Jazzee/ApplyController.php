...
class ApplyController extends Controller
{
 ...
 /**
  ...
  public function beforeAction(){
    ...
    if(!$this->_application) throw new \Jazzee\Exception("Unable to load {$this->actionParams['programShortName']} {$this->actionParams['cycleName']} application", E_USER_NOTICE, 'That is not a valid application');
